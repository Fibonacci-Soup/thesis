...
%****************************** MFHBO Chapter **********************************
%*******************************************************************************
\chapter{Multi Frame Holograms Batched Optimization for Binary Phase Spatial Light Modulators} \label{sec:Multi Frame Holograms Batched Optimization for Binary Phase Spatial Light Modulators}
...
\subsection{Simulation results}
	...
	\begin{figure}[h!t]
		\centering
		\includegraphics[width=0.85\textwidth]{optim_iter_flowchart.pdf}
