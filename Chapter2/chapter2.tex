...
Then, using \cref{eq:analytical_solution_FT_polygon_slope_form}, the analytical solution of the Fourier transform $S_\Delta(u,v)$ of the equilateral triangle with side length $L$ can be obtained:
\begin{align}
